...
public class TC29 extends SalesforceUltility {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement recentContact = setXpath("//a[contains(text(),'ABCD')]");
		recentContact.click();
		
		WebElement editButton = setXpath("//td[@id='topButtonRow']//input[@title='Edit']");
		explicitWait(5000, editButton);
