...
public class TC18 extends SalesforceUltility{
	...
	public static void main(String[] args) throws Exception{
		...
		WebElement stuckOppLink = setXpath("//a[normalize-space()='Stuck Opportunities']");
		stuckOppLink.click();
		explicitWait(5, driver.findElement(By.xpath("//select[@id='subtotalBy0']")));
